...
#                 f"save/forecasting_{dt}_{ii}_{pl}", "result_nsample100.pk"
#             )
...
result_pth = os.path.join(
    "/home/user/workspaces/CSDI/save/forecasting_mfred_1_288/generated_outputs_nsample100.pk"
)
with open(result_pth, "rb") as f:
...
fig, ax = plt.subplots()
ax.plot(y_real[-1])
ax.plot(y_pred_point[-1])
ax.plot(y_pred_q[-1,:,0])
